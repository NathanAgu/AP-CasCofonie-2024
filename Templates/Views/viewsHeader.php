...
<body>
    ...
    <div id="menuHolder">
      ...
      <div id="menuDrawer">
        ...
        <div>
          <a href="index.php" class="nav-menu-item"><i class="fas fa-home me-3">
          ...
          <a href="index.php?view=text&action=display" class="nav-menu-item">
          ...
          <a href="index.php?view=article&action=display" class="nav-menu-item">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bookmark" viewBox="0 0 16 16">
              <path d="M2 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v13.5a.5.5 0 0 1-.777.416L8 13.101l-5.223 2.815A.5.5 0 0 1 2 15.5zm2-1a1 1 0 0 0-1 1v12.566l4.723-2.482a.5.5 0 0 1 .554 0L13 14.566V2a1 1 0 0 0-1-1z"/>
            </svg> Articles</a>
          <a href="index.php?view=amendment&action=display" class="nav-menu-item">
          ...
          <a href="#" class="nav-menu-item">
            ...
            </svg> A Propos De Nous</a>
          <a href="index.php?view=role&action=display" class="nav-menu-item">
