<?php
    ...
    class controller
    {
        ...
        public function userRegisterVerif()
        {
            if (!empty($_POST))
            {
                $valid = (boolean) true;
                ...
                if (isset($_POST["userIdentifier"]) && isset($_POST["userPassword"]) && isset($_POST["userPasswordConfirmation"]))
                {
                    ...
                    else 
                    {
                        ...
                        $query = $accessDB->getConnexion()->prepare($sqlRequest);
                    ...
                    if ($valid)
                    {
                        ...
                        $query = $this->connexionDB->prepare($sqlRequest);
                        $query->bindValue(":userIdentifier", $userIdentifier);
        ...
        public function userLoginVerif()
        {
